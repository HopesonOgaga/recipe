...
})({"iVQoW":[function(require,module,exports) {
...
var _iconsSvg = require("../../../final/src/img/icons.svg");
...
///////////////////////////////////////
function spinner_render(parent_el) {
    const mark_up = `
     <div class="spinner">
        <svg>
  ...
  `;
    parent_el.innerHTML = "";
    parent_el.insertAdjacentHTML("afterbegin", mark_up);
}
const show_recipe = async function() {
    try {
        // const res = await fetch(
        //   `https://forkify-api.herokuapp.com/api/v2/recipes/5ed6604591c37cdc054bc886`
        // );
        // spiner loader
        spinner_render(recipeContainer);
        // async data loads
    ...
    <div class="recipe__directions">
      ...
      >
        ...
        recipeContainer.insertAdjacentHTML("afterbegin", mark_up);
    } catch (err) {
        alert(err);
    }
};
...
},{"core-js/modules/web.immediate.js":"49tUX","../../../final/src/img/icons.svg":"gpM6J","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
"use strict";
...
},{}],"gpM6J":[function(require,module,exports) {
module.exports = require("895469706f65ffe0").getBundleURL("iTq60") + "icons.12f9e444.svg" + "?" + Date.now();

},{"895469706f65ffe0":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}]},["iVQoW","fstXO"], "fstXO", "parcelRequirea6cc")
